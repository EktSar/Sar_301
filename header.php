        ...
        <div class="row text-center align-items-center">
            ...
            <nav class="col-4 col-sm-4 col-lg-9 col-xl-9">
                ...
                <ul class="menu">
                    ...
                    <li><a href="/preparing.php" class="menu__item">Подготовка</a></li>
                    <li><a href="/competitions.php" class="menu__item">Соревнования</a></li>
                    <li><a href="/system.php" class="menu__item">Система</a></li>
                    <li><a href="/gallery.php" class="menu__item">Фотогалерея</a></li>
                </ul>
            </nav>
